...
import useEmojiReactions from '../../../hooks/reactions/emojis/useEmojiReactions';
        ...
        {reactionSummary?.reactions?.map((reaction, index) => {
          return (
            <li className="" key={reaction.emoji}>
              <ActionButton
                type="mute"
                className={`rounded-none border-b-button hover:border-b-2 ${
...
export default ReactionDetailsDialog;
