      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex-1">
          ...
          <div className="mt-1 text-sm text-gray-400">
            ...
            .{' '}If you forgot your recovery phrase you can request it again by clicking the button below. There is a
            2-week waiting period to
            get your phrase.

            <br/>
            <br/>
            Keep your recovery phrase stored securely. The recovery phrase will enable you to reset forgotten passwords
            and to kick out a hacker
