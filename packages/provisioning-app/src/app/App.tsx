...
const ProvisionManagedDomain = lazy(
  () => import('../templates/Provision/ProvisionManagedDomain')
);
const ProvisionOwnDomain = lazy(
  () => import('../templates/Provision/ProvisionOwnDomain')
);
  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta
          name="description"
          content={`${config.brandName} - ${config.brandSlogan} `}
        />
            ...
            <Routes>
              ...
              >
                ...
                <Route path={ROOT_PATH}>
                  ...
                  <Route
                    path="managed-domain"
                    element={<ProvisionManagedDomain />}
                  />
