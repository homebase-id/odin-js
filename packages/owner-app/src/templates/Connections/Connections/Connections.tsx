...
import {runAutoFix} from '../../../provider/network/troubleshooting/AutoFixConnectionProvider';
            ...
            <PageMeta
                ...
                actions={
                    <>
                        ...
                        {hasDebugFlag() &&
                            <ActionButton isDisabled={autoFixRunning} onClick={doAutoFix}>
                                {t('Autofix')}
                            </ActionButton>
                        }
                    </>
