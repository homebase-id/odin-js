...
interface ImageCropperProps {
  ...
  onLoad?: (cropperRef: CropperRef) => void;
}
...
export const GetCroppedData = (
  cropperRef: React.RefObject<CropperRef> | React.MutableRefObject<CropperRef | undefined>
...
const ImageCropper = ({ imageUrl, expectedAspectRatio, onChange, onLoad }: ImageCropperProps) => {
  ...
  return (
    <>
      <Cropper
        ...
        rotatable={false}
        zoomable={false}
        onLoad={() => onLoad && internalRef.current && onLoad(internalRef.current)}
      />
      {!expectedAspectRatio ? (
        <div className="py-5">
